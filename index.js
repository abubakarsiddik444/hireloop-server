...
async function run() {
    try {
        ...
        app.get('/api/applications', async (req, res) => {
            ...
            const cursor = applicationsCallection.find(query);
            const result = await cursor.toArray();
            res.send(result);
        })
        ...
        app.post('/api/applications', async (req, res) => {
            ...
            const result = await applicationsCallection.insertOne(newApplication);
            res.send(result);
        })
        ...
        app.get('/api/plans', async (req, res) => {
            ...
            const plan = await planCallection.findOne(query);
            res.send(plan)
        })
        ...
        app.post('/api/subscriptions', async (req, res) => {
            ...
            const result = await subscriptionCallection.insertOne(subsInfo);
        ...
        // send a ping to confirm a sessessfull connection
